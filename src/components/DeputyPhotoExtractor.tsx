// DeputyPhotoExtractor: admin UI for triggering and monitoring deputy photo extraction
import React, { useState, useEffect } from 'react';
import { Users, Download, CheckCircle, AlertCircle } from 'lucide-react';
import { DeputyPhotoGrid } from './DeputyPhotoGrid';

export { DeputyPhotoGrid } from './DeputyPhotoGrid';
...
export default function DeputyPhotoExtractor() {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Extração de Fotos dos Deputados</h2>
      ...
      <DeputyPhotoGrid photos={existingPhotos} isExtracting={extracting} />
    </div>
  );
}
